...
use Closure;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\Algorithm;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\AlgorithmSettings;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\astar\AStar;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\cost\CostCalculator;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\cost\DefaultCostCalculator;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\path\PathPoint;
use kirathefenix98AP\Pets\entity\pathfinder\algorithm\path\PathResult;
...
class Navigator {
    ...
    public function registerBlockValidator(Block $block, Closure $closure): void {
        $this->blockValidators[$block->getStateId()] = $closure;
    }
